    ...
    <div data-testid="admin-settings-page">
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-12">
        ...
        <div className="rounded-2xl border border-white/10 bg-card p-6 lg:col-span-7">
          <div className="flex items-center gap-3">
            <span className="grid h-10 w-10 place-items-center rounded-xl border border-white/10 bg-ink-950 text-teal"><Mail className="h-5 w-5" strokeWidth={1.5} /></span>
            <div>
          ...
          <ul className="mt-6 divide-y divide-white/5" data-testid="admin-notifications-list">
