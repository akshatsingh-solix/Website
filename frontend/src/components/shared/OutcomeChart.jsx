  ...
  <div className="h-[300px] w-full" data-testid="outcome-chart">
    <ResponsiveContainer width="100%" height="100%">
      <BarChart data={data} layout="vertical" margin={{ top: 4, right: 24, bottom: 4, left: 8 }} barCategoryGap={22} barGap={6}>
        ...
        <XAxis type="number" domain={[0, 100]} tick={{ fill: "#B0B0B2", fontSize: 11, fontFamily: "JetBrains Mono" }} axisLine={false} tickLine={false} tickFormatter={(v) => `${v}`} />
        <YAxis type="category" dataKey="metric" width={190} tick={{ fill: "#F5F5F5", fontSize: 12 }} axisLine={false} tickLine={false} />
        <Tooltip content={<TooltipBox />} cursor={{ fill: "rgba(255,255,255,0.03)" }} />
        <Legend iconType="circle" iconSize={8} wrapperStyle={{ fontSize: 11, color: "#B0B0B2", paddingTop: 8 }} />
