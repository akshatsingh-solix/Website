...
export const DataFlowDiagram = () => {
  ...
  return (
    <svg viewBox="0 0 620 380" className="h-auto w-full" role="img" aria-label="Enterprise systems flowing into the Solix Common Data Platform and out to AI, analytics and compliance">
      ...
      {rightYs.map((y, i) => (
        <Flow key={`r${i}`} d={`M ${cx + 68} ${cy} C ${cx + 110} ${cy}, ${rightX - 60} ${y}, ${rightX} ${y}`} delay={0.6 + i * 0.5} color="#F97316" dur={2.8} />
      ))}
      ...
      <g transform={`translate(${cx} ${cy})`}>
        ...
        <g transform="translate(-14 -30)">
          <rect x="0" y="0" width="28" height="6" rx="1.5" fill="#F97316" />
          <rect x="0" y="9" width="28" height="6" rx="1.5" fill="#CBD5E1" />
          <rect x="0" y="18" width="28" height="6" rx="1.5" fill="#00D4FF" />
        </g>
